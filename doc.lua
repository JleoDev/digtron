...
if hoppers_enabled then
	digtron.doc.inventory_usagehelp = S("@1\n\nDigtron inventory modules are compatible with hoppers, adjacent hoppers will add to or take from their inventories. Hoppers are not part of the Digtron and will not move with it, however. They may be useful for creating a \"docking station\" for a Digtron.", digtron.doc.inventory_usagehelp)
end

if pipeworks_enabled then
	digtron.doc.inventory_usagehelp = S("@1\n\nInventory modules are compatible with Pipeworks blocks. When a Digtron moves one of the inventory modules adjacent to a pipe it will automatically hook up to it, and disconnect again when it moves on.", digtron.doc.inventory_usagehelp)
end
...
if hoppers_enabled then
	digtron.doc.fuelstore_usagehelp = S("@1\n\nDigtron fuel store modules are compatible with hoppers, adjacent hoppers will add to or take from their inventories. Hoppers are not part of the Digtron and will not move with it, however. They may be useful for creating a \"docking station\" for a Digtron.", digtron.doc.fuelstore_usagehelp)
end

if pipeworks_enabled then
	digtron.doc.fuelstore_usagehelp = S("@1\n\nFuel modules are compatible with Pipeworks blocks. When a Digtron moves one of the inventory modules adjacent to a pipe it will automatically hook up to it, and disconnect again when it moves on.", digtron.doc.fuelstore_usagehelp)
end
...
if pipeworks_enabled then
	digtron.doc.battery_holder_usagehelp = S("@1\n\nFuel modules are compatible with Pipeworks blocks. When a Digtron moves one of the inventory modules adjacent to a pipe it will automatically hook up to it, and disconnect again when it moves on.", digtron.doc.battery_holder_usagehelp)
end
...
if pipeworks_enabled then
	digtron.doc.inventory_ejector_usagehelp = S("@1\n\nItem ejectors are compatible with pipeworks and will automatically connect to a pipeworks tube if one is adjacent in the output location.", digtron.doc.inventory_ejector_usagehelp)
end
